package com.geely.design.pattern.structural.proxy.demo1.db;
...
//	<bean id="dataSource" class="com.geely.design.pattern.structural.proxy.demo1.db.DynamicDataSource">
