 ...
 * </html>
 */
package com.geely.design.ucaner.action.state.absState;

import com.geely.design.ucaner.action.state.allState.Close;
import com.geely.design.ucaner.action.state.allState.Open;
import com.geely.design.ucaner.action.state.allState.Run;
import com.geely.design.ucaner.action.state.allState.Stop;
